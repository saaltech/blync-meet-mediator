...
export const LEAVING_MEETING = 'LEAVING_MEETING';
export const SHOW_PARTICIPANTS_LIST = 'SHOW_PARTICIPANTS_LIST';
export const TOGGLE_PARTICIPANTS_LIST = 'TOGGLE_PARTICIPANTS_LIST';
export const SHOW_INVITE_PEOPLE = 'SHOW_INVITE_PEOPLE';
export const TOGGLE_INVITE_PEOPLE = 'TOGGLE_INVITE_PEOPLE';
